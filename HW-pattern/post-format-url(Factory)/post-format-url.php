...
Description: Add json to post permalink (Factory method).
Version: 0.1.0
...
class Post_Formatter_Factory
{
     ...
     * @return WP_Post_Formatter
     */
    public static function make_format($format)
    {
        $class_name = 'WP\Post_Format_' . strtoupper($format);
        if (!class_exists($class_name) && !is_a($class_name, 'WP_Post_Formatter'))
...
class Post_Formatter_Bootstrap
{
     ...
     * ~~~
     *
     * The Factory will returns an instance of WP_Post_Format_JSON and then
