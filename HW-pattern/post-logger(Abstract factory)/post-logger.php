...
Description: Logs when post is updated (Abstract factory design pattern).
Version: 0.1.0

*/

namespace WP\Post_Logger;
...
class Factory
{
    ...
    {
        $classname = 'WP\Post_Logger\Logger_' . ucfirst(strtolower($logger));
